...
[![Doubly Linked List](https://img.youtube.com/vi/xjkyuYtN-n4/0.jpg)](https://www.youtube.com/watch?v=xjkyuYtN-n4)


### Bubble Sort
##### Bubble Sort is a O(n²) sorting algorithm that takes the greatest number of each iteration and leave it at the end of the list. At the end of all iterations, we have a sorted array. Although it's not recommended for big arrays, it's simpler implementation allows sorting with no much effort.
[![Bubble Sort](https://img.youtube.com/vi/RVtJErFqehs/0.jpg)](https://www.youtube.com/watch?v=RVtJErFqehs)
